...
// TxId얻기, [tx In의 내용 + tx Out의 내용 + timestamp] hash
const getTxId = tx => {
  ...
  //console.log(`txInContent : ${txInContent} txOutCentent : ${txOutContent}`);
